...
-- LISTAR O NOME E A CIDADE DOS ESTADIOS EM QUE HOUVE TREINAMENTO.
SELECT E.NOME, E.END_CIDADE AS LOCAL
FROM ESTADIO E
WHERE EXISTS (SELECT * 
              FROM TREINAMENTO T
              WHERE T.ESTADIO_NOME = E.NOME);

-- LISTAR O NOME E A CIDADE DOS ESTADIOS QUE SEDIARAM FINAIS DE COPAS.
SELECT E.NOME, E.END_CIDADE AS LOCAL
FROM ESTADIO E
